 ...
 * @author fashionbrot
 */
public class ResponseUtilBackUp {
    ...
    public static void parseGenericField(Field field, Type classType,List<ParameterVo> parameterList){
        ...
        Type fieldType = TypeUtil.getFieldType(field, classType);
        if (fieldType!=null){
            Class typeConvertClass = TypeUtil.typeConvertClass(fieldType);
            if (typeConvertClass!=null){
                ...
                if (JavaUtil.isObject(typeConvertClass) || JavaUtil.isMap(typeConvertClass) || JavaUtil.isPrimitive(typeConvertClass)) {
                    ...
                    Type[] convertActualTypeArguments = TypeUtil.convertActualTypeArguments(fieldType);
                    if (ObjectUtil.isNotEmpty(convertActualTypeArguments)) {
                        ...
                        if (convertClass != null) {
                            ...
                            if (JavaUtil.isObject(convertClass) || JavaUtil.isMap(convertClass) || JavaUtil.isPrimitive(convertClass)) {
                                ...
                                parseClass(convertClass, convertActualTypeArguments[0], childList);
                            }
                ...
                }else if (JavaUtil.isArray(typeConvertClass)){
                    ...
                    parseClass(typeConvertClass,fieldType,childList);
                }
            }
        }
    ...
    public static void parseGenericField2(Field field, Type classType,List<ParameterVo> parameterList){
        ParameterVo parameterVo = AnnotationUtil.parseBaseType(field);
        List<ParameterVo> childList =new ArrayList<>();
...
//                    }
    ...
    public static void parseFieldList2(Field field, Type classType, List<ParameterVo> parameterList) {
        ParameterVo parameterVo = AnnotationUtil.parseBaseType(field);
        parameterVo.setCollection(1);
...
//                                        parseClass(convertClass, actualTypeArguments[0], parameterList);
                        ...
                        if (ObjectUtil.isNotEmpty(convertActualTypeArguments)){
                            ...
                            if (convertActualTypeArguments[0] instanceof Class){
                                ...
                                Class convertClass = TypeUtil.typeConvertClass(convertActualTypeArguments[0]);
                                if (convertClass!=null) {
                                    parseClass(convertClass, convertActualTypeArguments[0], childParameterList);
                                }
                            }
...
//                }
    ...
    public static void parseFieldArray(Field field,Type classType,List<ParameterVo> parameterList){
        ...
        Class componentType = TypeUtil.getFieldTypeClass(field,classType);
