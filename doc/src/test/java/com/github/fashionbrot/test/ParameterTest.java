...
public class ParameterTest {
    ...
    public class RequestReq1{
        ...
        private RequestTest.RequestReq2 requestReq2;
    }
    ...
    public class TestController2{
        ...
        @ResponseBody
        private RespVo test3(RequestTest.RequestReq1 req){
        ...
        @ResponseBody
        private RespVo test4(@RequestBody RequestTest.RequestReq1 req){
            return RespVo.success();
        }
    }
